...
def obtener_o_crear_reunion(fecha):
    ...
    # Crear la nueva reunión con el saldo inicial correcto
    cursor.execute("""
...
def registrar_movimiento(id_caja, tipo, categoria, monto):
    ...
    # E. Actualizar ingresos/egresos y saldo final
    if tipo == "Ingreso":
